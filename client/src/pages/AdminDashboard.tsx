  ...
  useEffect(() => {
    if (appSettingsData?.settings) {
      const getSettingValue = (key: string) => {
        const setting = appSettingsData.settings.find((s: any) => s.settingKey === key);
  ...
  const egiftSettingsMutation = useMutation({
    mutationFn: async (data: typeof egiftForm) => {
      ...
      for (const setting of settings) {
        await apiRequest("PATCH", `/api/admin/app-settings/${setting.settingKey}`, setting);
      }
    },
    onSuccess: () => {
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>Configure bank account details for guest monetary gifts</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleEgiftSubmit} className="space-y-6">
                  ...
                  <div className="p-4 border rounded-lg bg-blue-50/50">
                    <h3 className="font-medium text-gray-900 mb-4">Groom's Bank Account</h3>
                    <div className="grid gap-4 md:grid-cols-3">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setEgiftForm({ ...egiftForm, groomName: e.target.value })}
                          placeholder="Andreas"
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setEgiftForm({ ...egiftForm, groomBank: e.target.value })}
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setEgiftForm({ ...egiftForm, groomAccount: e.target.value })}
                  ...
                  <div className="p-4 border rounded-lg bg-pink-50/50">
                    <h3 className="font-medium text-gray-900 mb-4">Bride's Bank Account</h3>
                    <div className="grid gap-4 md:grid-cols-3">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setEgiftForm({ ...egiftForm, brideName: e.target.value })}
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setEgiftForm({ ...egiftForm, brideBank: e.target.value })}
                          placeholder="Bank BCA"
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setEgiftForm({ ...egiftForm, brideAccount: e.target.value })}
